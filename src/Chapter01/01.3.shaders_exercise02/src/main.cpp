...
int main()
{
    ...
    Shader shader("../shaders/01.3.shaders_exercise02.vert", "../shaders/01.3.shaders_exercise02.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float xPosOffset = std::sin(timeValue) * 0.5f;
        shader.setFloat("xOffset", xPosOffset);
