...
int main()
{
    ...
    Shader shader("../shaders/01.4.textures_exercise02.vert", "../shaders/01.4.textures_exercise02.frag");
    Texture containerTexture("container.jpg", GL_TEXTURE_2D, true, GL_RGB, GL_RGB, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR, true);
