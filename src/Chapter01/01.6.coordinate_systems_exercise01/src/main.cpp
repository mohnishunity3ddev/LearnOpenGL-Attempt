...
int main()
{
    ...
    Shader shader("../shaders/01.6.coordinate_systems_exercise01.vert", "../shaders/01.6.coordinate_systems_exercise01.frag");
    ...
    glm::mat4 model;
    model = glm::rotate(identity, glm::radians(-55.0f), glm::vec3(1.0f, 0.0f, 0.0f));
