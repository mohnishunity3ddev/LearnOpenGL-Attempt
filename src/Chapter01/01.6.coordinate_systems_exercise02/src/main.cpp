...
int main()
{
    ...
    Shader shader("../shaders/01.6.coordinate_systems_exercise02.vert", "../shaders/01.6.coordinate_systems_exercise02.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 view = glm::translate(identity, camPos);
