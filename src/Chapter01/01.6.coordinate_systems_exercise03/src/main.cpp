...
int main()
{
    ...
    Shader shader("../shaders/01.6.coordinate_systems_exercise03.vert", "../shaders/01.6.coordinate_systems_exercise03.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for(int i = 0; i < cubeCount; ++i) {
            ...
            float multiplier = (i % 3 == 2 || i == 0) ? time : 1.0f;
            model = glm::rotate(model, multiplier * glm::radians(angle), glm::vec3(1.0f, 0.3f, 0.5f));
