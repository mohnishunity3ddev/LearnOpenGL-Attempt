...
glm::vec3 redColor      = glm::vec3(1.0f, 1.0f,  1.0f);
...
int main() {
    ...
    Shader objectShader("../shaders/02.2.basic_lighting_exercise04.vert", "../shaders/02.2.basic_lighting_exercise04.frag");
    ...
    objectShader.use();
    objectShader.setVec3("lightColor", glm::value_ptr( redColor ));
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Light
        lightShader.setVec3("lightColor", &redColor[0]);
        ...
        objectShader.setVec3("camWorldPos", glm::value_ptr( camera.Position ));
