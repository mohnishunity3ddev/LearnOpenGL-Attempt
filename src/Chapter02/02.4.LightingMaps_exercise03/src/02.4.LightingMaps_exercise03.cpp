...
int main() {
    ...
    Shader objectShader("../shaders/02.4.lighting_maps_exercise03.vert", "../shaders/02.4.lighting_maps_exercise03.frag");
    ...
    Texture containerSpecular("lighting_maps_specular_color.png", GL_TEXTURE_2D, true, GL_RGB, GL_RGBA, GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR, true);
