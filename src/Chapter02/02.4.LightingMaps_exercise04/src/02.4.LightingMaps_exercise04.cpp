...
int main() {
    ...
    Shader objectShader("../shaders/02.4.lighting_maps_exercise04.vert", "../shaders/02.4.lighting_maps_exercise04.frag");
    ...
    Texture emissionMap("matrix.jpg", GL_TEXTURE_2D, true, GL_RGB, GL_RGB, GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR, true);
    ...
    emissionMap.bindToTextureUnit(2);
