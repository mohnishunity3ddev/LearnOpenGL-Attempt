...
int main() {
    ...
    // For MultiSampled AntiAliasing, we need a default framebuffer which has
    ...
    // all we need to do is hint GLFW that we'd like to use a multisample buffer
    // with N samples instead of a normal buffer by calling glfwWindowHint
    // before creating the window.
    glfwWindowHint(GLFW_SAMPLES, 4);
    // NOTE: When we now call glfwCreateWindow we create a rendering window, but this
    ...
    Shader shader("../shaders/antialiasing.vert", "../shaders/antialiasing.frag");
