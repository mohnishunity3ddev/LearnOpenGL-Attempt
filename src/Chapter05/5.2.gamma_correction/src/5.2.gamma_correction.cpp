...
int main() {
    ...
    Texture floorTexture("wood.png", false);
    Texture floorTextureGammaCorrected("wood.png", true);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glBindTexture(GL_TEXTURE_2D, (gammaEnabled ? floorTextureGammaCorrected.texture_handle : floorTexture.texture_handle));
        renderPlane();
